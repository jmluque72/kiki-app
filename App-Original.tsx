...
import { useCrashMonitoring } from './src/hooks/useCrashMonitoring';
...
const AppContent = () => {
  ...
  // Inicializar monitoreo de crashes
  ...
  useEffect(() => {
    ...
    if (isAuthenticated && user && user.email) {
      ...
      // Establecer contexto del usuario para crash monitoring
      crashMonitoring.setUser(user);
...
const App = () => {
  // Inicializar logging al arrancar la app (Sentry deshabilitado)
  useEffect(() => {
    try {
